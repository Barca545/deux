...
// -Could the start event just get passed a ground intersection and target from
// the intersection instead of holding the mouseray and calculating it? -Get rid
