// use crate::view::render_gl::{ModelVertex, Vertex};
// use gl::Gl;
...
// impl SkinnedMesh {
//   pub fn new(gl: &Gl, vertices: Vec<ModelVertex>, indices: Vec<u32>, texture_name: &str, scale_factor: f32) -> Self {
...
// impl StaticMesh {
//   pub fn new(gl: &Gl, vertices: Vec<ModelVertex>, indices: Vec<u32>, texture_name: &str) -> Self {
//     let pass = RenderPass::new(&gl)
//       .with_vert("CharacterVertexShader")
//       .unwrap()
//       .with_frag("CharacterFragShader")
