...
use crate::{
  data_lib::{BaseScript, Cooldown, Owner, PersistentScript, RunningScript},
  time::ServerTime
};

// Refactor:
// -If let for the stop branch might be unnecessary because I am pretty sure all
// scripts will have stop logic

///Creates a [`PersistentScript`] entity containing a reference to the
/// `running` script it executes and a [`Cooldown`] duration in seconds
