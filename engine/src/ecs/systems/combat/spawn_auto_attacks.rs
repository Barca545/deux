use crate::ecs::{command_buffer::AutoAttackSpawner, component_lib::{AutoAttack, AutoAttackCooldown, AutoAttackMesh, AutoAttackScript, MissleSpeed, Owner, Player, Position, SkinnedMesh, Target, Velocity}, World};
use eyre::Result;
