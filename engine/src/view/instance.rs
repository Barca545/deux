...
///Layout of an [`InstanceRaw`]'s matrix in the GPU. As a [`Mat4`] i.e. 4
/// vec4s, an `InstanceRaw` takes up four slots.
const INST_ATTRIBS:[VertexAttribute; 4] = vertex_attr_array![5 => Float32x4,6 => Float32x4,7 => Float32x4,8 => Float32x4,];

#[repr(C)]
#[derive(Debug, Default, Copy, Clone, Pod, Zeroable)]
///Struct containing position information needed for rendering an instance of a
/// `Mesh`.
