...
//this needs worlds because I made load resource from cstring a method on world, undo this and just make load from c_string a separate loader function
//verticies is the data stored in model. I do not think anything else needs the vertivies
//model may not need to be a distinct component
impl Mesh {
