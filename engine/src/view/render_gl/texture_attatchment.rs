...
use gl::{types::{GLuint, GLenum, GLint}, Gl, RGB_INTEGER, DEPTH_COMPONENT, TEXTURE_2D, RGB32I, UNSIGNED_INT, TEXTURE_MIN_FILTER, NEAREST, TEXTURE_MAG_FILTER, FLOAT, FRAMEBUFFER, COLOR_ATTACHMENT0, RGB32UI};
