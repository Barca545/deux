...
use gl::{
	types::{GLenum, GLuint},
	Gl, DEPTH_COMPONENT, DRAW_FRAMEBUFFER, FRAMEBUFFER, FRAMEBUFFER_COMPLETE,
	...
	INVALID_ENUM, INVALID_OPERATION, RGB_INTEGER, TEXTURE, TEXTURE_2D,
};
...
impl FrameBuffer {
	...
	pub fn delete(&self) {
		unsafe {
			self
				.gl
				.DeleteFramebuffers(1, self.buffer_obj as *const GLuint)
		}
	}
