use gl::{
  types::{GLenum, GLuint},
  Gl, DRAW_FRAMEBUFFER, FRAMEBUFFER, FRAMEBUFFER_COMPLETE, FRAMEBUFFER_INCOMPLETE_ATTACHMENT, FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER,
  FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS, FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT, FRAMEBUFFER_INCOMPLETE_MULTISAMPLE,
...
impl FrameBuffer {
  ...
  pub fn attach_2d_texture(&self, attachment:GLenum, texture_obj:GLuint) {
    unsafe {
      self.gl.FramebufferTexture2D(FRAMEBUFFER, attachment, TEXTURE_2D, texture_obj, 0);
    }
  }
