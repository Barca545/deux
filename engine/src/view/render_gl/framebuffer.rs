...
use gl::{types::{GLuint,GLenum}, Gl, TEXTURE_2D, FRAMEBUFFER, FRAMEBUFFER_COMPLETE, FRAMEBUFFER_UNDEFINED, FRAMEBUFFER_INCOMPLETE_ATTACHMENT, FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT, FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER, FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS, FRAMEBUFFER_INCOMPLETE_READ_BUFFER, FRAMEBUFFER_INCOMPLETE_MULTISAMPLE, INVALID_OPERATION, INVALID_ENUM, RGB_INTEGER, DEPTH_COMPONENT, TEXTURE, DRAW_FRAMEBUFFER};
...
impl FrameBuffer{
  ...
  pub fn new(gl:&Gl)->Self{
    let gl = gl.clone();
    //should this be 0? 0 is the default framebuffer. Maybe I want it to be another number?
    let mut buffer_obj:GLuint = 0;
    unsafe{
      gl.GenFramebuffers(1,&mut buffer_obj)
    }
    dbg!(buffer_obj);
  ...
  ///Checks whether the current framebuffer has successfully completed, returns an error otherwise.
  pub fn check_framebuffer_status(&self)->Result<()>{
    unsafe{
      ...
      match status {
        ...
        FRAMEBUFFER_INCOMPLETE_ATTACHMENT => return Err(FramebufferErrors::GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT.into()),
        FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT => return Err(FramebufferErrors::GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT.into()),
        FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER=> return Err(FramebufferErrors::GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER.into()),
        FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS => return Err(FramebufferErrors::GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS.into()),
        FRAMEBUFFER_INCOMPLETE_READ_BUFFER => return Err(FramebufferErrors::GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER.into()),
        FRAMEBUFFER_INCOMPLETE_MULTISAMPLE=> return Err(FramebufferErrors::GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE.into()),
