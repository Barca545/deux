...
// use gl::{
// 	types::{GLint, GLuint},
// 	Gl, COLOR_ATTACHMENT0, DEPTH_ATTACHMENT, DEPTH_COMPONENT, DRAW_FRAMEBUFFER,
// FLOAT, FRAMEBUFFER, 	NEAREST, NONE, READ_FRAMEBUFFER, RGB32I, RGB32UI,
// RGB_INTEGER, TEXTURE_2D, TEXTURE_MAG_FILTER, 	TEXTURE_MIN_FILTER,
// UNSIGNED_INT, };
// use image::Pixel;
// use nalgebra::Perspective3;

// use super::{
// 	pixel_info::PixelInfo, FrameBuffer, PickingProgram, Program, Texture,
// TextureAttachment, };
// use eyre::Result;

// //I think I need another struct that lists the object index and their pixel
// info together pub struct SelectableObject {
// 	fbo: FrameBuffer,
...
// 	pub fn new(gl: &Gl,name: &str, screen_dimensions: &ScreenDimensions) -> Self
// { 		let fbo = FrameBuffer::new(&gl);
// 		let program = PickingProgram::new(gl,  name);
...
// 	///Creates and attaches the texture object for the primitive information
// buffer. 	fn generate_information_buffer(&self) {
...
// 		//unsure if this should be in the main update function
// 		//do I want to use integers instead of floating points in order to avoid
// imprecision? 		self.depth_texture.generate_texture_attachment(
// 			&self.screen_dimensions,
// 			DEPTH_COMPONENT,
// 			DEPTH_COMPONENT,
// 			FLOAT,
...
// 	//I think the render for this should go into the Renderable Object render
// logic 	// pub fn render(&self){
// 	//   // Create the FBO
