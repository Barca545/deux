...
// use crate::math::{math::Vec3, Transforms};
...
// impl PickingProgram {
//   pub fn new(gl:&Gl, name:&str) -> Self {
//     let gl = gl.clone();
//     let shader_program = Program::from_shader_files(&gl, name);

//     //need to update the shader since the tutorial multiplies them in this code
...
//     self
//       .shader_program
//       .set_uniform_matrix4fv(self.model_uniform_loc, &transforms.get_model_transform(position));
...
//     //this could maybe be a function on the main program struct
//     unsafe { self.gl.Uniform1ui(self.draw_index_location, draw_index as GLuint) }
//   }
