...
// use crate::{
//   component_lib::{Position, StaticMesh},
//   ecs::{world_resources::ShaderPrograms, World},
//   math::{calculate_model_transform, math::Mat4, Vec3},
// };
// use gl::Gl;
...
//     //Get the mesh
//     let mesh = entity.get_component::<StaticMesh>().unwrap();
