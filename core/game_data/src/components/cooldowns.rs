...
use time::{BasicTimer, Miliseconds, ServerTime, Timer};
...
// -I don't think Cooldowns needs to exist, I will have the AbilityMap hold the
// cooldown data
...
impl Cooldowns {
  pub fn new(
    ...
    cooldowns.insert(
      ...
      Cooldown::new(server_time, auto,),
    );
    cooldowns.insert(
      String::from("auto cast time",),
      Cooldown::new(server_time, auto_windup,),
    );
    cooldowns.insert(
      String::from("ability 1",),
      Cooldown::new(server_time, ability_1,),
    );
    cooldowns.insert(
      String::from("ability 2",),
      Cooldown::new(server_time, ability_2,),
    );
    cooldowns.insert(
      String::from("ability 3",),
      Cooldown::new(server_time, ability_3,),
    );
    cooldowns.insert(
      String::from("ability 4",),
      Cooldown::new(server_time, ability_4,),
    );
