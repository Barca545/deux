...
//   #[error("Framebuffer is the default read or draw framebuffer, but the
// default framebuffer does not exist.")]   GL_FRAMEBUFFER_UNDEFINED,
...
//   #[error("The value of GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE is GL_NONE for
...
// attached renderbuffers; if the value of GL_TEXTURE_SAMPLES is the not same
// for all attached textures; or, if the attached images are a mix of
// renderbuffers and textures, the value of GL_RENDERBUFFER_SAMPLES does not
// match the value of GL_TEXTURE_SAMPLES or the value of
...
// textures.")]   GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE,
//   #[error("A framebuffer attachment is layered, and a populated attachment is
// not layered, or if all populated color attachments are not from textures of
// the same target.")]   GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS,
//   #[error("Target was not GL_DRAW_FRAMEBUFFER, GL_READ_FRAMEBUFFER or
// GL_FRAMEBUFFER.")]   GL_INVALID_ENUM,
//   #[error("Framebuffer was not zero or the name of an existing framebuffer
...
//   #[error("Shader is not a value generated by OpenGL or maxLength is less
// than 0.")]   GL_INVALID_VALUE,
//   #[error("Shader is not a value generated by OpenGL.")]
//   GL_INVALID_OPERATION,
//   #[error("No uniform was found matching the name.")]
//   UniformLocationNotFound,
//   #[error("{error:?}")]
//   ShaderDidNotCompile { error: String },
// }

#[derive(Debug, Error,)]
#[allow(non_camel_case_types)]
pub enum MeshErrors {
  #[error("Meshes must have a registered material")]
  NoRegisteredMaterial,
}
