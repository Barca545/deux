// use thiserror::Error;
// // TODO: This should be just in the ECS
// #[derive(Debug, Error,)]
// pub enum EcsErrors {
//   #[error("Attempting to add {component:?} to an entitity without registering
// it first!")]   CreateComponentNeverCalled { component:String, },
